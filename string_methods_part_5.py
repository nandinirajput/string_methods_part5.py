...
# print(a.partition("are")) #('hello world how' 'are' 'you how do you do')partition which means it seperates the word
print(a.rpartition("how")) #('hello world how are you', 'how', 'do you do')
